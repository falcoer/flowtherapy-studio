...
test("brand roles, shared image, independent campaign snapshot and identity backup", async ({
  page,
}) => {
  const errors: string[] = [];
  ...
  await page.screenshot({
    path: "test-results/branding-desktop.png",
    fullPage: true,
  });
  ...
  await page.screenshot({
    path: "test-results/branding-mobile.png",
    fullPage: true,
  });
